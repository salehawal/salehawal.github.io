...
function genGallery(imgs,location)
{
	...
	if(imgs.length > 0)
	{
		for(var img in imgs) blockhtml += '<div class="block-img"><img src="'+location+'/'+imgs[img]+'" onmouseover="magnifyImage(this);" onmouseout="hideMagnify();" onclick="viewImage(this)"></div>';
...
function magnifyImage(img)
{
	 ...
	 document.getElementById("magnify").innerHTML = '<img src="'+img.src+'"></img>';
}
...
{
	var projects = Array('alriyadh - COD.png','alwani-prefumes.png','archiving.jpg','babili-group.jpg','checkque_print.jpg','data-collection.png','data-entry.png','dsb-01.png','dsb-03.png','dsb-04.png','dsb-05.png','eimarah-webapp-new.png','experts-01.png','experts-02.png','experts-03.png','experts-04.png','experts-06.png','experts-07.png','experts-09.png','experts-10.png','fitcles.png','fore-vision.png','highclass.png','inventory01.png','inventory02.png','inventory03.png','inventory04.png','inventory05.png','inventory06.png','inventory07.png','irehab-co.png','jeddaheshop_arabnews.png','jeddaheshop_com.png','jomlah_com.jpg','mof.png','moi - web.jpg','new-theme-login.png','ozone.png','pr-01.png','pr-04.png','pr-05.png','report-form-new-car.png','report-validation.jpg','reporting.jpg','s4em-01.png','s4em-02.png','s4em-03.png','s4em-04.png','s4em-05.png','s4em-06.png','s4em-07.png','s4em-08.png','sarf-01.png','sarf-02.png','sso-dashboard.png','sso-news.png','sso.png','suppor-admin.png');
