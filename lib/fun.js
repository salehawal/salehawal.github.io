...
{
	var projects = Array(['beatcme.png','https://beatcme.org'],['intern.png','https://intern24.org'],['lal.png','https://lal.one'],'alwani-prefumes.jpg','babili-group.jpg','sms-alert.jpg','dsb-01.jpg','dsb-03.jpg','dsb-04.jpg','dsb-05.jpg','experts-01.jpg','experts-02.jpg','experts-03.jpg','experts-06.jpg','experts-07.jpg','app-inventory.jpg','jeddaheshop_com.jpg','ozone.jpg','pr-01.jpg','pr-04.jpg','pr-05.jpg','s4em-02.jpg','s4em-03.jpg','s4em-04.jpg','s4em-07.jpg','s4em-08.jpg','support_web_admin.jpg','bayan.jpg','eform_zawaj.jpg','sso.jpg','maleyah_reports.jpg','22.jpg','wiki.jpg');
	genGallery(projects,'img/projects','gallery-prj');
}

function loadAchivments()
{
	var projects = Array(['jomlah.com.jpg','https://jomlah.com'],['news_mof.jpg','https://www.alriyadh.com/497018'], ['news_cod.jpg','https://www.alriyadh.com/478779'],['jeddah_eshops.jpg','https://www.arabnews.com/node/307897'],'civil_defence.jpg');
...
function YoutubeLink(videoParam) {
    ...
    xhr.onreadystatechange = function () {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            // Append video block to div#youtubeblocks
            var container = document.getElementById("youtubeblocks");
            if (container) {
